...
serve(async (req) => {
  ...
  try {
    ...
    if (ttnConfig.hasGatewayKey && ttnConfig.gatewayApiKey) {
      console.log(
        `[ttn-gateway-preflight] [${requestId}] Organization has dedicated gateway API key`,
      );
      ...
      console.log(
        `[ttn-gateway-preflight] [${requestId}] Preflight passed - using dedicated gateway key`,
      );
    ...
    console.log(
      `[ttn-gateway-preflight] [${requestId}] Checking API key scope via auth_info at ${CLUSTER_BASE_URL}`,
    );
    ...
    if (!authInfoResponse.ok) {
      ...
      console.error(
        `[ttn-gateway-preflight] [${requestId}] auth_info failed: ${authInfoResponse.status} ${errorText}`,
      );
    ...
    console.log(
      `[ttn-gateway-preflight] [${requestId}] Auth info structure:`,
      JSON.stringify({
    ...
    console.log(
      `[ttn-gateway-preflight] [${requestId}] Key type: ${keyType}, scope: ${ownerScope}, id: ${scopeId}`,
    );
    ...
    console.log(
      `[ttn-gateway-preflight] [${requestId}] Rights count: ${rights.length}, gateway read: ${hasGatewayRead}, write: ${hasGatewayWrite}`,
    );
    ...
    console.log(
      `[ttn-gateway-preflight] [${requestId}] Preflight passed - gateway provisioning allowed`,
    );
