    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          // UI component library (all Radix primitives)
          'vendor-ui': [
          ...
          // Animation library (heavy ~40KB, used on select pages)
          'vendor-animation': ['framer-motion'],
          // Real-time WebSocket client
          'vendor-realtime': ['socket.io-client'],
          // Dashboard grid layout (only used on dashboard/detail pages)
          'vendor-grid': ['react-grid-layout', 'react-resizable'],
          // Icon library (large tree-shakeable set)
