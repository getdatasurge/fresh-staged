 ...
 * Falls back to useUserRole directly if not in provider
 */
function usePermissionContext(): PermissionContextValue {
  const context = useContext(PermissionContext);
  // Always call useUserRole unconditionally to satisfy React hooks rules
  const roleInfo = useUserRole();

  // Use context if available, otherwise fall back to direct hook result
