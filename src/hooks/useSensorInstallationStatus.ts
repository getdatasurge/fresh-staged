  ...
  if (loraSensor) {
    ...
    if (loraSensor.status === 'pending') {
      return {
        ...
        bgColor: 'bg-muted',
        description:
          'Sensor is being registered with the network. This usually takes a few seconds.',
      };
    }
    ...
    if (!lastActivity) {
      ...
      return {
        ...
        bgColor: 'bg-warning/10',
        description:
          'Sensor is paired but has never reported data. Check sensor placement and power.',
      };
    }
    ...
    return {
      ...
      bgColor: 'bg-warning/10',
      description:
        'Sensor was previously active but is not currently reporting. Check connectivity.',
    };
  }
