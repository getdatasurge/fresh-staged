...
export function useSoftDelete() {
  ...
  const permanentlyDeleteUnitMutation = useMutation(trpc.units.permanentlyDelete.mutationOptions());
  const permanentlyDeleteAreaMutation = useMutation(trpc.areas.permanentlyDelete.mutationOptions());
  const permanentlyDeleteSiteMutation = useMutation(trpc.sites.permanentlyDelete.mutationOptions());
  ...
  const restoreUnit = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to restore unit';
      toast.error(message);
  ...
  const restoreArea = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to restore area';
      toast.error(message);
      return { success: false, error: message };
    }
  };

  const restoreSite = async (siteId: string, organizationId: string): Promise<SoftDeleteResult> => {
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to restore site';
      toast.error(message);
      return { success: false, error: message };
    }
  };
  ...
  const restoreDevice = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to restore device';
      toast.error(message);
      return { success: false, error: message };
    }
  };
  ...
  const permanentlyDeleteUnit = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to permanently delete unit';
      toast.error(message);
      return { success: false, error: message };
    }
  };
  ...
  const permanentlyDeleteArea = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to permanently delete area';
      toast.error(message);
      return { success: false, error: message };
    }
  };
  ...
  const permanentlyDeleteSite = async (
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'Failed to permanently delete site';
      toast.error(message);
      return { success: false, error: message };
    }
  };
  ...
  const permanentlyDeleteDevice = async (
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : 'Failed to permanently delete device';
      toast.error(message);
      return { success: false, error: message };
    }
  };
