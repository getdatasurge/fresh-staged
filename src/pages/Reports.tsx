...
const Reports = () => {
  ...
  const sitesQuery = useQuery(
    trpc.sites.list.queryOptions(undefined, { enabled: isInitialized && !!effectiveOrgId }),
  );
  ...
  const handleExport = (
    reportType: 'daily' | 'exceptions' | 'manual' | 'compliance',
    format: 'csv' | 'pdf' = 'csv',
  ) => {
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      onClick={() =>
                        handleExport(
                          report.id as 'daily' | 'exceptions' | 'manual' | 'compliance',
                          'csv',
                        )
                      }
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    handleExport(report.id as 'daily' | 'exceptions' | 'manual' | 'compliance')
                  }
