    ...
    <DashboardLayout title="Inspector Mode">
      ...
      <Tabs defaultValue="daily" className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => handleExport("daily")} disabled={exportMutation.isPending}>
              <Download className="w-4 h-4 mr-2" />
              Export Daily CSV
            </Button>
            <Button variant="outline" onClick={() => handleExport("exceptions")} disabled={exportMutation.isPending}>
              <Download className="w-4 h-4 mr-2" />
