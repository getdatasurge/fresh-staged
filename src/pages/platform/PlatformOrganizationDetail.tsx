...
export default function PlatformOrganizationDetail() {
  ...
  const { logSuperAdminAction, setViewingOrg, isSupportModeActive, startImpersonation } =
    useSuperAdmin();
  const trpc = useTRPC();
  ...
  return (
    <PlatformLayout title={organization.name} showBack backHref="/platform/organizations">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{organization.unitsCount || 0}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
