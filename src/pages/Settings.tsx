...
const Settings = () => {
  ...
  const userRole = ((isImpersonating ? 'admin' : profileQuery.data?.role) as AppRole) || null;
  ...
  const isLoading = profileQuery.isLoading || orgQuery.isLoading || !identityInitialized;
    ...
    <DashboardLayout title="Settings">
      <Tabs defaultValue={defaultTab} className="space-y-6">
        ...
        <TabsContent value="security">
          <SecurityTab currentRole={userRole} organizationId={organization?.id || null} />
        </TabsContent>
        ...
        <TabsContent value="billing">
          {organization && (
            <BillingTab organizationId={organization.id} canManageBilling={canManageBilling} />
          )}
        </TabsContent>
            ...
            <CardContent className="space-y-6">
              ...
              {notifSms && (
                <div className="space-y-3 pt-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Required for SMS alerts. Use international format starting with + and country
