          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <div className="space-y-8 text-foreground/90">
              <section>
                ...
                <p className="mb-4">
                  FrostGuard, a product of OEM Auto Marine Inc ("we," "our," or "us"), is committed
                  to protecting your privacy. This Privacy Policy explains how we collect, use,
                  disclose, and safeguard your information when you use our refrigeration monitoring
                  service.
                </p>
                <p>
                  By using FrostGuard, you agree to the collection and use of information in
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    organization details when you create an account.
                  </li>
                  <li>
                    <strong>Device Data:</strong> Temperature readings, sensor status, battery
                    levels, and connectivity information from monitoring devices.
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Information about how you interact with our
                    service, including log entries, alert acknowledgments, and report generation.
                  </li>
                  <li>
                    <strong>Technical Data:</strong> IP address, browser type, device information,
                    and access times for security and service improvement.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Send temperature alerts and notifications via SMS, email, or push notifications
                  </li>
              ...
              <section className="bg-accent/5 border border-accent/20 rounded-lg p-6">
                ...
                <p className="mb-4">
                  <strong>Important:</strong> This section specifically addresses how we handle
                  phone numbers and SMS communications:
                </p>
                <ul className="list-disc pl-6 space-y-3">
                  <li>
                    <strong>Opt-In Only:</strong> We only send SMS messages to phone numbers that
                    have been explicitly opted-in to receive temperature alerts and notifications.
                    You must actively consent to receive SMS alerts during account setup or through
                    your notification settings.
                  </li>
                  <li>
                    <strong>Purpose:</strong> SMS messages are used solely for critical temperature
                    alerts, equipment status notifications, and service-related communications. We
                    do not send marketing or promotional messages via SMS.
                  </li>
                  <li>
                    <strong>No Selling or Sharing:</strong> We do not sell, rent, lease, or share
                    your phone number with third parties for marketing purposes. Your phone number
                    is used exclusively for FrostGuard alert notifications.
                  </li>
                  <li>
                    <strong>Message Frequency:</strong> Message frequency varies based on your alert
                    settings and temperature events. You control which alerts you receive through
                    your account settings.
                  </li>
                  <li>
                    <strong>Opt-Out:</strong> You can opt out of SMS notifications at any time by
                    replying
                    <strong> STOP</strong> to any message or by updating your notification
                    preferences in your account settings.
                  </li>
                  <li>
                    <strong>Carrier Rates:</strong> Standard message and data rates may apply
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    providers (such as cloud hosting and SMS delivery services) who assist in
                    operating our service. These providers are bound by contractual obligations to
              ...
              <section>
                ...
                <p>
                  ...
                  provide you services, comply with legal obligations (including food safety
                  record-keeping requirements), resolve disputes, and enforce our agreements.
                  Temperature logs may be retained for extended periods to meet HACCP and regulatory
              ...
              <section>
                ...
                <p>
                  FrostGuard is not intended for use by individuals under the age of 18. We do not
