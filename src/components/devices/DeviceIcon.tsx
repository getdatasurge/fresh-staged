...
export function DeviceIcon({
  ...
  return <Icon className={cn(sizeClasses[size], categoryDef.color, statusClass, className)} />;
}
...
export function CategoryIcon({ category, size = 'md', className }: CategoryIconProps) {
  ...
  return <Icon className={cn(sizeClasses[size], categoryDef.color, className)} />;
}
