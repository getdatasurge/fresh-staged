...
export function getDefaultLayout(entityType: EntityType = 'unit'): ActiveLayout {
  const baseLayout =
    entityType === 'site' ? DEFAULT_SITE_DASHBOARD_LAYOUT : DEFAULT_UNIT_DASHBOARD_LAYOUT;
...
export function getEmptyLayout(entityType: EntityType = 'unit'): ActiveLayout {
  const config = entityType === 'site' ? EMPTY_SITE_LAYOUT_CONFIG : EMPTY_UNIT_LAYOUT_CONFIG;
...
export function getDefaultWidgetPositions(entityType: EntityType = 'unit') {
  const config = entityType === 'site' ? DEFAULT_SITE_LAYOUT_CONFIG : DEFAULT_UNIT_LAYOUT_CONFIG;
