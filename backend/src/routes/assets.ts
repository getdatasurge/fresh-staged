...
import { UploadQuerySchema, UploadResponseSchema, type AssetType } from '../schemas/assets.js';
  ...
  app.post(
    ...
    async (request, reply) => {
      try {
        ...
        const validation = assetStorageService.validateFile(file.mimetype, fileBuffer.length);
