...
export const widgetHealthRouter = router({
	 ...
	 */
	getFailuresByLayer: orgProcedure
		.input(GetFailuresByLayerSchema)
		.query(async ({ input }) => {
	 ...
	 */
	hasCriticalIssues: orgProcedure
		.input(HasCriticalIssuesSchema)
		.query(async ({ input }) => {
	 ...
	 */
	getBufferedEvents: orgProcedure
		.input(GetBufferedEventsSchema)
		.query(async ({ input }) => {
	 ...
	 */
	resetOrgCounters: protectedProcedure
		.input(ResetOrgCountersSchema)
		.mutation(async ({ input }) => {
