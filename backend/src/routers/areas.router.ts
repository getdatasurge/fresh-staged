...
export const areasRouter = router({
  ...
  list: orgProcedure
    ...
    .query(async ({ ctx, input }) => {
      const areas = await areaService.listAreas(input.siteId, ctx.user.organizationId);
      return areas;
    }),
  ...
  listWithUnitCount: orgProcedure
    ...
    .query(async ({ ctx, input }) => {
      return areaService.listAreasWithUnitCount(input.siteId, ctx.user.organizationId);
    }),
  ...
  get: orgProcedure
    ...
    .output(AreaSchema)
    .query(async ({ ctx, input }) => {
      const area = await areaService.getArea(input.areaId, input.siteId, ctx.user.organizationId);
  ...
  create: orgProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const area = await areaService.createArea(input.siteId, ctx.user.organizationId, input.data);
