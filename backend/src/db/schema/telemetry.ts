...
export const entityDashboardLayouts = pgTable(
  ...
  (table) => [
    index('entity_dashboard_layouts_entity_idx').on(table.entityType, table.entityId, table.userId),
...
export type InsertEntityDashboardLayout = typeof entityDashboardLayouts.$inferInsert;
