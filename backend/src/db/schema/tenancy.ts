...
import { complianceModeEnum, subscriptionPlanEnum, subscriptionStatusEnum } from './enums.js';
...
export const organizations = pgTable(
  'organizations',
  {
    ...
    complianceMode: complianceModeEnum('compliance_mode').notNull().default('standard'),
...
export const ttnConnections = pgTable(
  'ttn_connections',
  {
    ...
    provisioningStatus: varchar('provisioning_status', { length: 256 }).default('not_started'),
