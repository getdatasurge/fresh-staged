...
**Phase 41 - Pages:** 4. TTNCredentialsPanel has reduced test coverage (5 vs 21 tests)

**Pre-existing:** 5. 15 failures in tests/api/ttn-devices.test.ts (unrelated to migration)
