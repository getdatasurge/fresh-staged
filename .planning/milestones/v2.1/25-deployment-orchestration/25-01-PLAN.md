...
2. **Integrate into argument parsing**:
  ...
  <verify>
1. Help flag works: `./scripts/deploy-automated.sh --help`
2. Short help works: `./scripts/deploy-automated.sh -h`
3. Help shows all options: `./scripts/deploy-automated.sh --help | grep -E "\-\-reset|\-\-skip-prereqs|\-\-help"`
4. Help shows phases: `./scripts/deploy-automated.sh --help | grep -E "Pre-flight|Prerequisites|Configuration|Deployment"`
  </verify>
  <done>
