...
- 9 dashboard widgets migrated to tRPC (UnitComparison, Annotations, SiteActivityGraph, SensorSignalTrend, UnitComplianceScore, UnitsStatusGrid, EventTimeline, DowntimeTracker, ManualLogStatus) — v2.4
- 7 settings components migrated to tRPC (EmulatorSyncHistory, NotificationSettingsCard, WebhookStatusCard, AlertRulesScopedEditor, EmulatorResyncCard, SmsAlertHistory, TTNProvisioningLogs) — v2.4
- 7 pages migrated to tRPC (Inspector, OrganizationDashboard, ManualLog, Reports, Onboarding, TTNCleanup, HealthDashboard) — v2.4
