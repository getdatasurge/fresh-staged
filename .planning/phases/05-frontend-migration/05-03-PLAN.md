...
export const readingsApi = {
  ...
  getLatestReading: async (
    ...
    const response = await client
      .get(`api/orgs/${orgId}/units/${unitId}/readings?limit=1`)
      .json<ReadingsListResponse>();
...
export const alertsApi = {
   ...
   */
  getAlert: async (orgId: string, alertId: string, accessToken: string): Promise<AlertResponse> => {
    const client = createAuthenticatedClient(accessToken);
