...
must_haves:
  truths:
    - 'User can perform application updates safely'
    - 'User can back up and restore the database'
    - 'User can scale the application for growth'
    - 'User can monitor system health ongoing'
  artifacts:
    - path: 'docs/deployment/operations.md'
      provides: 'Complete operations guide'
      min_lines: 200
  key_links:
    - from: 'docs/deployment/operations.md'
      to: 'scripts/deploy-automated.sh'
      via: 'update procedure reference'
      pattern: 'deploy-automated.sh'
---

<objective>
Create comprehensive post-deployment operations guide (DOCS-04) covering updates, backups, scaling, and ongoing maintenance.

Purpose: Users need clear procedures for day-to-day operations after deployment. The existing operations.md is minimal (90 lines). This needs to be a complete operations manual.

Output: Comprehensive docs/deployment/operations.md
</objective>
...
<task type="auto">
  <name>Task 1: Rewrite Operations Manual - Updates and Backups</name>
  <files>docs/deployment/operations.md</files>
  <action>
Replace the entire contents of docs/deployment/operations.md with a comprehensive operations guide:
...
````
  ...
  <verify>
Verify operations guide has update and backup sections:
- grep "Application Updates" docs/deployment/operations.md (should find section)
- grep "Database Backups" docs/deployment/operations.md (should find section)
- grep "Disaster Recovery" docs/deployment/operations.md (should find section)
- wc -l docs/deployment/operations.md (should be significantly more than 90 lines)
  </verify>
  <done>Operations manual covers updates, backups, and disaster recovery procedures</done>
</task>

<task type="auto">
  <name>Task 2: Add Scaling, Monitoring, and Security Sections</name>
  <files>docs/deployment/operations.md</files>
  <action>
Append the following sections to docs/deployment/operations.md (after the Disaster Recovery section):
...
- **Documentation:** docs/SELFHOSTED_DEPLOYMENT.md
...
```
  ...
  <verify>
Verify complete operations guide:
- grep "Scaling" docs/deployment/operations.md (should find section)
- grep "Monitoring" docs/deployment/operations.md (should find section)
- grep "Security Maintenance" docs/deployment/operations.md (should find section)
- grep "Quick Reference" docs/deployment/operations.md (should find section)
- wc -l docs/deployment/operations.md | awk '$1 >= 200 {print "PASS: " $1 " lines"}'
  </verify>
  <done>Operations manual is comprehensive with scaling, monitoring, security, and service management</done>
</task>

</tasks>

<verification>
1. Update procedures documented:
   - Standard update process
   - Version-specific updates
   - Rollback procedure

2. Backup procedures documented:
   - Automated backup explanation
   - Manual backup commands
   - Restoration steps
   - Test restoration (non-destructive)

3. Scaling documented:
...
5. Security maintenance documented:
   - SSL renewal (auto)
   - System updates
   - Secret rotation
   - fail2ban management
...
<success_criteria>
- User can perform application update following documented steps
- User can create and restore database backups
- User can scale application (at least vertically)
- User can monitor system health using Grafana
- User can perform security maintenance tasks
</success_criteria>

<output>
After completion, create `.planning/phases/37-documentation/37-04-SUMMARY.md`
</output>
```
