...
- All isSupabaseMigrationError checks
  ...
  <verify>
  grep "supabase-placeholder" src/components/NotificationDropdown.tsx # Should return nothing
  npx tsc --noEmit
  </verify>
...
- The procedure should insert into manual_temperature_logs, corrective_actions, and update alerts
  ...
  <verify>
  grep "supabase-placeholder" src/components/LogTempModal.tsx # Should return nothing
  npx tsc --noEmit
  </verify>
...
- All UI rendering code
  ...
  <verify>
  grep "supabase-placeholder" src/components/platform/GlobalUserSearch.tsx # Should return nothing
  npx tsc --noEmit
  </verify>
