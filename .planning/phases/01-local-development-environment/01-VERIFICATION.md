...
| 6 | pnpm db:migrate applies schema to database successfully | ✓ VERIFIED | Migration applied, drizzle.__drizzle_migrations has 1 record |
...
| Migration system | Database | applied migration | ✓ WIRED | drizzle.__drizzle_migrations has record |
