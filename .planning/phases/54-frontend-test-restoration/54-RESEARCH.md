...
**Source:** src/hooks/__tests__/useSites.test.tsx, src/hooks/__tests__/useAlerts.test.tsx
...
**Source:** src/hooks/__tests__/useAlerts.test.tsx (useAcknowledgeAlert, useResolveAlert)
...
expect(mockMutationFn).toHaveBeenCalledWith(expect.objectContaining({ organizationId: 'test-org' }), expect.anything())
...
**Source:** src/components/settings/__tests__/TTNCredentialsPanel.test.tsx (existing)
