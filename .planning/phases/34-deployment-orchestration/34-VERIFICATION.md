...
| `scripts/deploy-orchestrated.sh` | Main deployment orchestrator (min 80 lines)         | VERIFIED (438 lines) | Executable (-rwxr-xr-x). Has --resume, --fresh, --status, --help flags. Defines 10 phase\_\* functions. Sources deploy-lib.sh and calls deployment_checkpoint for each phase. |
