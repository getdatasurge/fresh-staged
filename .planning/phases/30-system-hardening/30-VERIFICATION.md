...
| 7   | Edge function calls return structured errors with feature names | ✓ VERIFIED | functions.invoke returns \_\_unavailable marker with function name     |
...
| src/lib/supabase-placeholder.ts | functions.invoke | structured error return | ✓ WIRED | Returns { data: null, error: SupabaseMigrationError, \_\_unavailable: functionName } at lines 124-133 |
| src/lib/supabase-placeholder.ts | rpc              | structured error return | ✓ WIRED | Returns { data: null, error: SupabaseMigrationError, \_\_unavailable: functionName } at lines 112-121 |
...
- ✓ rpc returns structured error with \_\_unavailable marker
