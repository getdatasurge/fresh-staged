...
2. **Identify refactoring-sensitive areas** based on:
   ...
   - Dead or unused code
3. **Output a tactical game plan** to `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs\code-refactoring/LOOP_00001_GAME_PLAN.md`

## Analysis Checklist

- [ ] **Survey codebase (if needed)**: First check if `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs\code-refactoring/LOOP_00001_GAME_PLAN.md` already exists with at least one tactic defined. If it does, skip the survey and mark this task complete—the game plan is already in place. If it doesn't exist, examine project structure, find largest files, identify patterns. Note file size distribution and any obvious organizational issues.

## Output Format

Create/update `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs\code-refactoring/LOOP_00001_GAME_PLAN.md` with the following structure:
