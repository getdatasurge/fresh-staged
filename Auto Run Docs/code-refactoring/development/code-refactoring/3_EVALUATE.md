...
1. **Read `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_CANDIDATES.md`** to get the list of candidates
2. **Read `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md`** (if it exists) to see which candidates have already been evaluated
...
6. **Append to `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md`**

## Evaluation Checklist

- [ ] **Evaluate one candidate (or skip if empty)**: Read Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_CANDIDATES.md. If it contains no findings OR all findings have already been evaluated in LOOP_00001_PLAN.md, mark this task complete without changes. Otherwise, pick one unevaluated candidate, assess risk/benefit, and append to Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md.
...
Append to `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md` using this structure (create file with header if it doesn't exist):
...
1. You've evaluated exactly ONE candidate from `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_CANDIDATES.md`
2. You've appended a complete evaluation to `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md`
