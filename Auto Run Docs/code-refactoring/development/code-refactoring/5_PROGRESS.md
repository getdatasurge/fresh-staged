...
1. **Read `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_PLAN.md`** to check for remaining work
2. **Read `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/LOOP_00001_CANDIDATES.md`** to check tactic exhaustion status
...
- [ ] **Check for remaining work**: Read LOOP_00001_PLAN.md and LOOP_00001_CANDIDATES.md. The loop should CONTINUE (reset docs 1-4) if EITHER: (1) there are items with status exactly `PENDING` that have LOW risk AND HIGH/VERY HIGH benefit, OR (2) CANDIDATES.md does NOT contain `## ALL_TACTICS_EXHAUSTED`. The loop should EXIT (do NOT reset) only when BOTH conditions are false: no auto-implementable PENDING items AND all tactics are exhausted.
...
- [ ] **Reset 1_ANALYZE.md**: Uncheck all tasks in `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/1_ANALYZE.md`
- [ ] **Reset 2_FIND_ISSUES.md**: Uncheck all tasks in `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/2_FIND_ISSUES.md`
- [ ] **Reset 3_EVALUATE.md**: Uncheck all tasks in `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/3_EVALUATE.md`
- [ ] **Reset 4_IMPLEMENT.md**: Uncheck all tasks in `Z:\home\swoop\swoop-claude-projects\fresh-staged\Auto Run Docs/4_IMPLEMENT.md`
